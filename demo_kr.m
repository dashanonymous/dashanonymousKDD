...
writematrix(time_dash,'./result/kr/time_dash.csv','Delimiter',',')
%
writematrix(fit_dash,'./result/kr/fit_dash.csv','Delimiter',',')
%
writematrix(fit_local_dash,'./result/kr/fit_local_dash.csv','Delimiter',',')
